...
export const codingTestAPI = {
  generate: (data) => api.post('/coding-test/generate', data),
  run: (data) => api.post('/coding-test/run', data),
  submit: (data) => api.post('/coding-test/submit', data),
  history: () => api.get('/coding-test/history'),
};
