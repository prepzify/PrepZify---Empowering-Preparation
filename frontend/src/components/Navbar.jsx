...
import { FiHome, FiFileText, FiEdit3, FiBookOpen, FiUsers, FiMessageCircle, FiBriefcase, FiLogOut, FiCode } from 'react-icons/fi';

const navLinks = [
  { path: '/dashboard', label: 'Dashboard', icon: FiHome },
  { path: '/resume', label: 'Resume', icon: FiFileText },
  { path: '/test', label: 'Mock Test', icon: FiEdit3 },
  { path: '/coding-test', label: 'Coding Test', icon: FiCode },
